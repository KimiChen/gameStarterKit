...
- **2026-09-24 框架 SC5 冻结通知**（tag `stage3d-v1-frozen`）：SC0–SC5 已全部退出，消费面与证据见 [3d.md §10.1](docs/3d.md#101-v1-冻结面与证据索引)。[CLIENT §6](docs/CLIENT.md#6-设计分辨率与资源导出) 已给出作者输入、独立 PNG、两档 LOD、bundle / meta 与验收动线；[tools/art3d](tools/art3d/README.md) 提供固定依赖和转换作业 schema。自动蒙皮简化仅支持 primitive 内一致权重，lvr 复杂角色须审核手工变体；默认限帧与内容容量仍按自身配置验收。本条只通知框架就绪，lvr 未立项，A0–A5 不勾选。

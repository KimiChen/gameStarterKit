...
>
> - **仍未实现的开放项**登记在 [docs/EXTRAS.md §5.2](docs/EXTRAS.md#52-未实现的开放项登记2026-09-06-自-plan-系列归并)；
> - **有意保留的边界**（⛔ 不是待办）登记在 [docs/EXTRAS.md §5.3](docs/EXTRAS.md#53-有意保留的边界登记备查-不是待办)；
> - 专项的阶段状态各有其唯一真相，本文件 ⛔ 不复制：Snake 见
>   [apps/plugins/snake/README.md](apps/plugins/snake/README.md)，插件分享平台见
>   [docs/PLUGIN-REGISTRY.md](docs/PLUGIN-REGISTRY.md) §7，kit 地基层见 [docs/KIT.md](docs/KIT.md) §9。
>
> 历史归档链：[plan-v4.md](plan-v4.md)、[plan-v3.md](plan-v3.md)、[plan-v2.md](plan-v2.md)、
> [plan.md](plan.md)——⛔ 不要从任何归档的完成标记推导当前状态。
...
| B 编辑器 / Creator 待办（6 条） | 5 条仍未实现 → EXTRAS §5.2 U1–U5；B5「合成 `.meta` 的 Creator 确认」2026-09-05 已闭合（Creator 3.8.8 未重写任何合成 `.meta`，证据在 [docs/evidence/creator-2026-09-05/](docs/evidence/creator-2026-09-05/README.md)），保留为「下次 Creator 版本升级时复核」 |
...
- plan-v4 承接的 5 条产品/工程留白已全部实施完毕；Non-intrusive 框架侧阶段 0–9 已实施（证据表在历史归档
  [plan-v4.md](plan-v4.md)「Non-intrusive 阶段 0–9 实施证据」）；drop-in 房型框架已实施。

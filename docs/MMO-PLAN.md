...
- [x] MK2-B1（本行所在提交：`combat` 面 shared / client + 服务端施法管线（读条 / 瞬发 / 打断 / 二次校验 / 直伤・治疗・aura / 死亡・复活 / checkpointOnDeath）+ 框架 `calcDamageWithDefense` 公式族 + private 流 cooldowns / casting（modeVersion 5）+ 灰盒 v4 技能族；kit 0.1.7） [ ] MK2-B2…B3 [ ] MK3-B1…B3 [ ] MK4-B1…B6

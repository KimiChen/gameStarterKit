<!--
  ...
  采纳状态：2026-09-19 M01–M20 全部采纳进 MMO.md v1.1（MMO.md §12 有登记）；M01 取方案②（草案不入库、正文自包含）；
  lvr.md「跨服等 MF8」的改口径与 slg.md / lvr.md 对 MF5a / MF7a 的改引本轮未做（裸写 MF5 / MF7 仍指两半都退出，旧引用有效）。
-->
# docs/MMO.md 审阅报告

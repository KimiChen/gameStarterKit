...
| S1-04 | [已完成] | `d18846a` | shared/client typecheck；exact/default/order/hash 正反测试 | [公共目录](../../apps/shared/src/gameplays/snake/cosmetics.ts) · [hash](evidence/s1/catalog-hashes.json) | 16 active、唯一默认 1、版本 1；未改 gameplay wire/schema/protocol |

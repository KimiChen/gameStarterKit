...
| B 编辑器 / Creator 待办（6 条） | 5 条仍未实现 → EXTRAS §5.2 U1–U5；B5「合成 `.meta` 的 Creator 确认」2026-09-05 已闭合（Creator 3.8.8 未重写任何合成 `.meta`，证据在 docs/evidence/creator-2026-09-05/（本地预览证据，按 .gitignore 政策不入库）），保留为「下次 Creator 版本升级时复核」 |

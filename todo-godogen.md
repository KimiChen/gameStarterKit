...
> 的既有门禁口径，也不改变 [plan-v2.md](plan-v2.md) 的核心优先级；两者分工见 §7。
>
...
- [plan-v2.md](plan-v2.md) 是**核心问题、实施状态与验收证据的唯一真相**，其条目状态由对应门禁背书。
- 本文是**额外能力的对照吸收计划**：任务完成前不得写进 `plan-v2.md` 的完成声明，也不得据此放宽

...
微信/抖音渠道账号、登录、支付、广告、分享 SDK；渠道打包、审核、灰度（⚠ 与 docs/3d.md SD10 不冲突：SD10 要求 WebGL1 下 low 档表现及 lvr-3d.md R0 的 A3 真实微信远程加载 / 缓存证据；微信测试项目 / AppID 与可运行构建证据已从 3D 前置 / 验收 / 退出要求中移除）；**热更新**；合规与商店发布；

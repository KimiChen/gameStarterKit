...
import type { SchemaDomainArtifact } from "./schemaDomainCodegen";
 ...
 * 这是 plugin 侧 codegen 层的契约变更确认位（PLUGIN.md §8/§9）——⛔ 不做「注释也算」的豁免：digest 与
...
function generatedHeader(): string {
  return `/** AUTO-GENERATED by apps/server/tools/plugin-codegen/cli.ts from ${SOURCE_LABEL}. Do not edit. */`;
}
...
export function renderRegistry(descriptors: PluginDescriptors): string {

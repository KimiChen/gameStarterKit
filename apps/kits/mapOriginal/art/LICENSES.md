...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `decor-config.json` | （合成，见说明） | `c1f94005bf4fc28ddbf959f9433610ede0313f08594c0f8f8085f2235ec3a6e6` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/decor-config.json`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/resources/decor-config-c1f94005bf4fc28d.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 2 | `tops-config.json` | （合成，见说明） | `47aea4b12c48851a6eb11caaa869a265adc64e33cb9d90acbadbd4fd33f532df` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/tops-config.json`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/tops-config-47aea4b12c48851a.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 3 | `overview.png` | （合成，见说明） | `0df4e975eec0becf8893921abdda8330478feaca4daf348d9d31886a19ac95e6` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/overview.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/overview/overview-0df4e975eec0becf.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 4 | `overview.info.json` | （合成，见说明） | `f11b96a8d67944f1e49c2d93b0f1bf58743368c5ce8f25485ca4d75227d88c07` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/overview.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 5 | `mapo-sprite.effect` | （合成，见说明） | `f938c0fd08b9ab4e0d4ae95eb38bd25d07060d399564658444258e9560d12f17` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/mapo-sprite.effect`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/overview/mapo-sprite-f938c0fd08b9ab4e.effect` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 7 | `river-mask.png` | （合成，见说明） | `47eabacda02e96b8dbdfe71c6c7ac5686f32f9efd32cfc6914bdbda761091caa` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/river-mask.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/water/river-mask-47eabacda02e96b8.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 8 | `river-normal.png` | （合成，见说明） | `70ff42046936b1728f7fd0f63660edbdc97c49a3d6a2a9990a8aafec52441fe1` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/river-normal.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/water/river-normal-70ff42046936b172.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 9 | `grid-line.png` | （合成，见说明） | `06eb72a6a58a1d564c9811b76c520aa6c1d46a750e1a387b9d61e57e01877aac` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/grid-line.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/grid/grid-line-06eb72a6a58a1d56.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 10 | `surface.info.json` | （合成，见说明） | `ce63f5c13537b6147e10c6aa61967f787c014f7e57b5abad5d2947f34c37bac2` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/surface.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 11 | `choose.info.json` | （合成，见说明） | `7ba3a03152dd0953e4185883ac26c260c83b2569013c8a336bdeacb997047a7d` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/choose.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 12 | `terrain.bytes` | （合成，见说明） | `bbdec7fd14aa609852dbff765a476868edb846c3a0458b4d6185fd84760b3eaa` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/terrain.bytes`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/selection/terrain-bbdec7fd14aa6098.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 13 | `terrain.pass.bytes` | （合成，见说明） | `cffa7328b450f4018b3becae74cf4da4409d3a9539621259a562045417a29158` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/terrain.pass.bytes` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 14 | `terrain.info.json` | （合成，见说明） | `71df8aa653cc90516d6ac831be79b74860de2699f00c781ab790ec1d4b89698e` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/terrain.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 15 | `ground-base.png` | （合成，见说明） | `3f5f85df9e5ce417017f6b9ca9dcc3a09880fae2b70e61902dfb4d7f3a74a2da` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/ground-base.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/ground-base-3f5f85df9e5ce417.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 16 | `ground.info.json` | （合成，见说明） | `90dd4ff3115d89512a68b394bebab0f1fb0da6736fce6a4b9c83abc4edcf94ed` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/ground.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 17 | `desert-base.png` | （合成，见说明） | `4d61842eef65bdfd6f962d0617a2045e2f60e061d789e792b31459af1b4d285a` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/desert-base.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/desert-base-4d61842eef65bdfd.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 18 | `desert-geo.bin` | （合成，见说明） | `a8f5f30bdfb76b289891d266c4ef5a1f48ee90eaeaabd1da84647f61972c08de` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/desert-geo.bin`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/desert-geo-a8f5f30bdfb76b28.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 19 | `desert.bin` | （合成，见说明） | `d1eab68848e64b95ce96bac104ea71de6b53d856d52eef9d4775b77fb97a7b57` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/desert.bin`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/desert-d1eab68848e64b95.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 20 | `snow-base.png` | （合成，见说明） | `2180f6f6dc9aa9d9f97e8ca2f01cfcf662521fdcf55e8a2d33add8b495e7916b` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/snow-base.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/snow-base-2180f6f6dc9aa9d9.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 21 | `snow-geo.bin` | （合成，见说明） | `20725d7a6e3ede79a8eb1fdbde8ef48f8e536c61bf36345eefa884e893ebb866` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/snow-geo.bin`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/snow-geo-20725d7a6e3ede79.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 23 | `blocks.info.json` | （合成，见说明） | `355b519ba13076921d20355a9b827a12670f7cbfb2075ab95bff52152cd14fb4` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/blocks.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 24 | `bands.bytes` | （合成，见说明） | `6a1288b64666cd62406f3b7f93ce992940155eff1c01d5fc66e5d77fb85b70ba` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/bands.bytes` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 25 | `bands.info.json` | （合成，见说明） | `d3ed18465289991b761fbbf7cc414f95d6f7f39ca6af3aa9f76026f5aa27429d` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/bands.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 26 | `river-top-atlas.png` | （合成，见说明） | `0e4a840d14f6aca0b083e26f08928d5add262d632a5cb13870284526e6c88582` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/river-top-atlas.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/river-top-atlas-0e4a840d14f6aca0.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 27 | `river-tops.bin` | （合成，见说明） | `d5f70d5111c00b4226a7cd74d30e105b78126c6a95df6fee44abc415977bb169` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/river-tops.bin`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/river-tops-d5f70d5111c00b42.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 28 | `desert-top-atlas.png` | （合成，见说明） | `d80d9361315beb30a9a85ece1187b37979845a6964d84a288870f64cfeb121da` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/desert-top-atlas.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/desert-top-atlas-d80d9361315beb30.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 29 | `desert-tops.bin` | （合成，见说明） | `cba59e01a1a42204eab8aad530cbfb778fde17719bae3dd2c7fa8a10a8304788` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/desert-tops.bin`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/desert-tops-cba59e01a1a42204.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 30 | `snow-top-atlas.png` | （合成，见说明） | `3aab34e875d95cd748e813c06bfe4eac6c1a8e15db039313bafc56bfb5534ef4` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/snow-top-atlas.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/snow-top-atlas-3aab34e875d95cd7.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 31 | `snow-tops.bin` | （合成，见说明） | `3a0e83d6a164cba46c4076d04fe7a6fd36cac1a5ece1e5895bbece2615b9aa32` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/snow-tops.bin`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/snow-tops-3a0e83d6a164cba4.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 32 | `top-atlas.info.json` | （合成，见说明） | `d2945914dfa58c7c48ac9b6c6deb108764070d16027b8854cb28acbf7a1ae5a4` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/top-atlas.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 35 | `roads.info.json` | （合成，见说明） | `8f2445de9dc18b0223c7923f54acb2d5ff1124d284c9a6adbe3b34cc180e489d` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/roads.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 36 | `minimap.info.json` | （合成，见说明） | `7cad1ebcbaf87f0541e4f5ccdcc13ff5614a84bfc23e6f59033f9c604eeeb0d5` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/minimap.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 37 | `minimap.png` | （合成，见说明） | `7d017231c4c2de081e4b9174e8c977821bc6af381c36a2be6a082f2842d66eb4` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/minimap.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/overview/minimap-7d017231c4c2de08.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 38 | `minimap-mask.png` | （合成，见说明） | `5606bcf12a163623c995c01c0edb831674d19fcbc183f7f7a922f162808f02eb` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/minimap-mask.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 40 | `decor-atlas.info.json` | （合成，见说明） | `fe9e61b24dc85861cef0c425c733f55b116b64c1be2ed1b38f0fe17bc4efbc57` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/decor-atlas.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 42 | `region-atlas.info.json` | （合成，见说明） | `481bdfee978b117ba2303ab52ba5161de57ae21bd21c93f273a83b7996cc10c0` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/region-atlas.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 43 | `regions.bin` | （合成，见说明） | `ca44fbe70217bf7db1e7b7e3650686ff4a969fbf3f23110dff50e89788f28ce8` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/regions.bin`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/regions-ca44fbe70217bf7d.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 44 | `regions.info.json` | （合成，见说明） | `919824349ac4d064eaaeefdae351b4f9386d4827a1a4d36e4cca5a2ca7f23b4b` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/regions.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 45 | `river-fill.png` | （合成，见说明） | `1b56b30492f222ceebcef19888977ad862afd03ccb8e571e192336f53177084f` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/river-fill.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/river-fill-1b56b30492f222ce.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 46 | `river-geo.bin` | （合成，见说明） | `834447c193f63306119dfe0b2fbde4a43382df8bf04f4d0d9dfe3729bf9cd579` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/river-geo.bin`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/river-geo-834447c193f63306.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 47 | `rivers.bin` | （合成，见说明） | `8e9301179adadb242da0046164c908722c1cc29e0cb6c4b40c44ab84205c485a` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/rivers.bin`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/geography/rivers-8e9301179adadb24.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 48 | `rivers.info.json` | （合成，见说明） | `d4c5cf1dedd2bb03f55bf503e73530e90b40341225a1d746f8c455c5c31b4379` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/rivers.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 49 | `river-geo.index.json` | （合成，见说明） | `594ce1fe3486417c6e74b28dcdfb28d9b2d9ddff072d7717aa491c5d3c2fa431` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/river-geo.index.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 51 | `cities.bin` | （合成，见说明） | `0ac7fd1c19d2ec86442903ebc1930bbae49f89608d34d4a39b7d95459609c689` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/cities.bin`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/cities/cities-0ac7fd1c19d2ec86.bin` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 52 | `cities.info.json` | （合成，见说明） | `d06a35da2876b72b5c5b6a26cbcf83ea8108c6c70998d8ea70ff5761de56720c` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/cities.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 53 | `choose.png` | （合成，见说明） | `08602f33ff0be2b3126869236ab0bc691b8ff4add9c0fd36fde7c56c2491c202` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/choose.png`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/choose/choose-08602f33ff0be2b3.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 54 | `labels.json` | （合成，见说明） | `c801263fa8c7c6e8a4398557fc8569309459163ebec3f6963c2e98b8b6df5bad` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/labels.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 55 | `manifest.json` | （合成，见说明） | `ec5ef7d817bb9139c502569f0a6518cef3c1728e90f5279abddd12814c8d1077` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/manifest.json`<br>`apps/Cocos/assets/bundles/kit-mapOriginal-s1/2d/manifest.json` | 安装器绑定逻辑组、源文件 SHA-256、CRC32 与 shared 配置哈希；平台派生纹理由 Creator 构建缓存绑定 | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |

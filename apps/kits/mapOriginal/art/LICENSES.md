...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | `overview.png` | （合成，见说明） | `4c76b229d7c7629ac0c5ca198049aa6b0ff73c1dcb7bc15732620d5218fac033` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/overview.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 2 | `overview.info.json` | （合成，见说明） | `ba5579317da914cc5eb236b3fc57d93b80548284cd71161dcf849f6791992014` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/overview.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 28 | `snow-top-atlas.png` | （合成，见说明） | `288ab72dd35092595c30cd065e3432567af6a69ee4da0299701a8bb9a7bf690f` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/snow-top-atlas.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 30 | `top-atlas.info.json` | （合成，见说明） | `67853a5199b15ab58d323f4a580cc414bccd83314ec68b200aa6836fb353e8fa` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/top-atlas.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
| 31 | `road-atlas.png` | （合成，见说明） | `db7f8abc44a3dc1a9ae70140113c77c06e16862846a8eb3ae11106c282f3a594` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/road-atlas.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 33 | `roads.info.json` | （合成，见说明） | `f77b4c2bada20789db7e3d46d6c991e3ccc871da4f253f3d0a68dfe27147533e` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/roads.info.json` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 35 | `minimap.png` | （合成，见说明） | `bc7460667f259acbde7c90a9c2c82cff38ca10bee037840ed43324b5218d812c` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/minimap.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 39 | `region-atlas.png` | （合成，见说明） | `ea8b371965e7ef7807ac5fa07ae8e23c8defb2e0af9ba3fc8fb651995dc8719f` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/region-atlas.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |
...
| 48 | `city-atlas.png` | （合成，见说明） | `36f919c726df47d8ffc1355b3b12c2ab204e20d41d7565941707144fc00f2f20` | 见抬头 | 见抬头 | `apps/kits/mapOriginal/data/maps/s1/city-atlas.png` | 由 tools/maporiginal-assets 管线从原版数据层/贴图派生（见 out/sources.jsonl） | `本仓确定性铸造 uuid=sha1(mapOriginal::<相对路径>)` | 已引入，待验收 |

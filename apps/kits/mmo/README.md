...
| MK4 编排与验收 | orchestration 面 + 运行器 + harness、贡献点装载、卸载 / 升级闸、说明书、容量证据、冻结 `mmo-kit-v1-frozen` | 施工中：B1 orchestration 面 ✅、B2 贡献点装载 ✅、B3 卸载 / 升级闸 ✅、B4 说明书 ✅ 2026-09-20（kit 0.1.16；本 README「一、说明书」）；B5 容量证据 / B6 冻结未完 |
...
- 容量数字（20 s / 种子 7 / 同机同进程机器人；⚠ 只作比较与阈值判定）：MK1 退出——A 40 人 192 只 tick p99 16.2 ms、出站 p50 40.2 KB/s/会话；B 热点 500 只 slime 25 人 p99 15.9 ms ✅、50 人 20.8 / 24.2 / 24.8 ms（三次）✅、100 人 55.2 ms ❌（v1 例外：互见 ≤ 50）。**MK4-B5 最终数字与故障矩阵全表见 MMO.md §12 MK4 行（施工中，本批回写）。**

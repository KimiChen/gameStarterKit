...
export const componentUsage: Readonly<Record<string, string>> = {
    ...
    "cmp-countdown-days": '<Countdown target={targetIso} format="D天 HH:mm:ss" left={0} top={0} width={674} height={56} font={font} fontSize={28} color={pageText} backgroundColor={pageSurfaceAlt} />',
    "cmp-countdown-hours": '<Countdown durationSeconds={3 * 3600 + 4 * 60 + 5} left={0} top={0} width={674} height={56} font={font} fontSize={28} color={pageText} backgroundColor={pageSurfaceAlt} />',
    "cmp-countdown-minutes": '<Countdown durationSeconds={5 * 60 + 30} format="mm:ss" left={0} top={0} width={674} height={56} font={font} fontSize={28} color={pageText} backgroundColor={pageSurfaceAlt} />',
    "cmp-countdown-chinese": '<Countdown durationSeconds={86400 + 2 * 3600 + 3 * 60 + 4} format="D天HH时mm分ss秒" left={0} top={0} width={674} height={56} font={font} fontSize={28} color={pageText} backgroundColor={pageSurfaceAlt} />',

...
export const componentUsage: Readonly<Record<string, string>> = {
    ...
    "cmp-progress": '<ProgressBar skin={heroProgress} left={0} top={0} width={320} height={34} value={72} max={100} label="72%" />',
    "cmp-progress-star": '<ProgressBar skin={starUpgradeProgress} left={0} top={0} width={391} height={44} value={40} max={45} label="40/45" />',
    "cmp-progress-march": '<ProgressBar skin={allianceMarchProgress} left={0} top={0} width={420} height={28} value={65} max={100} label="65/100" />',
    "cmp-progress-flag": '<ProgressBar skin={allianceFlagProgress} left={0} top={0} width={420} height={28} value={60} max={100} />',
    "cmp-progress-battle-green": '<ProgressBar skin={battleGreenProgress} left={0} top={0} width={171} height={29} fillWidth={97} label="120/500" />',
    "cmp-progress-battle-red": '<ProgressBar skin={battleRedProgress} left={0} top={0} width={171} height={29} fillWidth={97} label="120/500" />',

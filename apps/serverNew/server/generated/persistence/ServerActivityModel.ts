...
@Index('sid', ['sid'], {})
@Entity('server_activity')
export class ServerActivityModel extends BaseEntity {
    @PrimaryGeneratedColumn({ type: 'int', name: 'id' })
    id!: number

    @Column('int', { name: 'sid', comment: '区服编号', default: () => "'0'" })
    sid!: number
    ...
    static readonly f_cross_id = 'cross_id'

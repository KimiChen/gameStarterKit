...
export class add_table_server_activity_1699866768000 implements MigrationInterface {
    async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
        CREATE TABLE server_activity (
            id int(11) NOT NULL AUTO_INCREMENT,
            sid int(11) NOT NULL DEFAULT '0' COMMENT '区服编号',
            ...
            cross_id int(11) NOT NULL DEFAULT '0' COMMENT '跨服活动的id,用作跨服的标识',

/**
 * outbox relayer —— **独立单例进程**（[04 · relayer](../../../../docs/server/04-cross-store-outbox.md#relayer崩溃收敛)）。
 *
...
import { outboxStats, redisApply, trimApplied, type Effect } from "./outbox";

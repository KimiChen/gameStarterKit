 ...
 * 登记见 docs/SERVER.md §13）。复用 `framework/infra/redisScripts.ts` 的 `defineScript` +
 * `evalshaWithReload` 装载器，⛔ 不另建装载器；与 `framework/infra/lease.ts`（singleton
 ...
 */
import { defineScript } from "../../../framework/infra/redisScripts";

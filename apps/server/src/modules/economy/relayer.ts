 ...
 *
 * 启动：node --import tsx src/modules/economy/relayer.ts
 */
...
import { LeaseLostError, makeHolderId, tryAcquireLease, withLeaseTx, type SingletonLease } from "../../framework/infra/lease";

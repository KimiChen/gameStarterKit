 ...
 */
import { CUR_GOLD } from "../../framework/infra/config";
import { kCacheCurrency, zoneCtx } from "../../framework/infra/keys";
import { cacheClient } from "../../framework/infra/redisRoute";
...
import { InsufficientBalanceError, StaleFenceError } from "../../framework/errors";
import { storedInt } from "../../framework/infra/numbers";

const CACHE_TTL_S = 300; // 5m（模块私有常量；key 分类真源见 framework/infra/keys.ts）

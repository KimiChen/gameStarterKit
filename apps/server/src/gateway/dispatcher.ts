/**
 * RPC dispatcher（[03 · RPC dispatcher](../../../../docs/server/03-gateway-data-layer.md#rpc-dispatcher)）。
 *
...
import { kIdemUser, kRl } from "../infra/keys";
import { clientFor, clientForKey } from "../infra/redisRoute";
...
export interface RpcEnvelope { id: string; type: string; payload?: unknown }
export interface RpcReply { id: string; ok: boolean; data?: unknown; err?: { code: string; msg: string } }

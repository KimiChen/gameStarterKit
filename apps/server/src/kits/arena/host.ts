 ...
 * （`../../framework/infra/kitApi`）取得，⛔ 本 kit 的服务端代码不 import framework/infra 其他模块、不 import ioredis / mysql2
 ...
 * ⛔ 插件不得 import 本文件。
 */
import { currentZoneId, readKitUserField } from "../../framework/infra/kitApi";

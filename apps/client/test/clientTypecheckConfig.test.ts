...
test("client headless tsconfig strictly includes all source and test TypeScript files", () => {
  ...
  for (const required of [
    ...
    "src/app/appGeneration.ts",
    "src/app/builtinPlugin.ts",
    "src/app/PluginRegistry.ts",
    "src/app/PluginHost.ts",
    "src/app/NavigationService.ts",
    "src/app/loginFlow.ts",
    "src/app/RefreshCoordinator.ts",
    "src/app/PendingOperationJournal.ts",
    "src/app/FrameScheduler.ts",
    "src/app/ports.ts",

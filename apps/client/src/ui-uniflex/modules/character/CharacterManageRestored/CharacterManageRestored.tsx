...
import { CharacterManageTab } from '../CharacterManage/CharacterManageTab';
import { CharacterPlayerRow } from '../CharacterManage/CharacterPlayerRow';
import { CharacterServerItem, type CharacterServerStatus } from '../CharacterManage/CharacterServerItem';
...
export interface CharacterManageRestoredParams {
...
export const CharacterManageRestored = defineView<CharacterManageRestoredParams | void>({ zIndex: 'window' }, (context) => {

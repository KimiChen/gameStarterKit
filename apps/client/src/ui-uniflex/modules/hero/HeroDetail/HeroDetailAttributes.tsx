    ...
    return (
        <view name="HeroDetailAttributes" visible={p.visible !== false}
            ...
            <image source={imageRef('ui/hero-detail/rank-s')}
                style={{ position: 'absolute', left: 75, top: 54, width: 122, height: 160 }} />
            <image source={imageRef('ui/hero-detail/faction')}
                style={{ position: 'absolute', left: 280, top: 118, width: 59, height: 71 }} />
            <image source={imageRef('ui/hero-detail/bond-icon')}
                style={{ position: 'absolute', left: 352, top: 125, width: 50, height: 53 }} />
            <image source={imageRef('ui/hero-detail/bond-icon')}
                style={{ position: 'absolute', left: 415, top: 125, width: 50, height: 53 }} />
            <view interaction="press" onClick={() => p.onPowerInfo?.()}
                style={{ position: 'absolute', left: 185, top: 724, width: 381, height: 74 }}>
            ...
            <image source={imageRef('ui/hero-detail/attr-header')}
                style={{ position: 'absolute', left: 21, top: 896, width: 708, height: 47, sizeMode: 'sliced' }} />
            <image source={imageRef('ui/hero-detail/attr-body')}
                style={{ position: 'absolute', left: 21, top: 943, width: 708, height: 95, sizeMode: 'sliced' }} />
            <text value={p.level ?? 'Lv.99'}
                style={{ position: 'absolute', left: 21, top: 892, width: 708, height: 52,
            ...
            <image source={imageRef('ui/hero-detail/attr-sword')}
                style={{ position: 'absolute', left: 49, top: 953, width: 48, height: 72 }} />
            <text value={stats[0] ?? '3941'}
                style={{ position: 'absolute', left: 100, top: 965, width: 110, height: 48,
            ...
            <image source={imageRef('ui/hero-detail/attr-shield')}
                style={{ position: 'absolute', left: 222, top: 955, width: 52, height: 64 }} />
            <text value={stats[1] ?? '3941'}
                style={{ position: 'absolute', left: 276, top: 965, width: 110, height: 48,
                    font: fontRef('fonts/regular', 700), fontSize: 32, color: '#3F3254', bold: true, verticalAlign: 'center' }} />
            <image source={imageRef('ui/hero-detail/attr-icon4')}
                style={{ position: 'absolute', left: 402, top: 955, width: 56, height: 52 }} />
            <text value={stats[2] ?? '3941'}
                style={{ position: 'absolute', left: 460, top: 965, width: 110, height: 48,
                    font: fontRef('fonts/regular', 700), fontSize: 32, color: '#3F3254', bold: true, verticalAlign: 'center' }} />
            <image source={imageRef('ui/hero-detail/attr-icon5')}
                style={{ position: 'absolute', left: 575, top: 957, width: 52, height: 48 }} />
            <text value={stats[3] ?? '3941'}
                style={{ position: 'absolute', left: 628, top: 965, width: 90, height: 48,
                    font: fontRef('fonts/regular', 700), fontSize: 32, color: '#3F3254', bold: true, verticalAlign: 'center' }} />
            <view interaction="press" onClick={() => p.onUpgrade?.()}
                style={{ position: 'absolute', left: 227, top: 1075, width: 297, height: 109 }}>

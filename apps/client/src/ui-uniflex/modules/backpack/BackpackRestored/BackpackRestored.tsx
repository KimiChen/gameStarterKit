...
import { BackpackItemCard, type BackpackItem, type BackpackQuality } from '../../../restored/modules/backpack/Backpack/components/BackpackItemCard';
import { BackpackQuantityControl } from '../../../restored/modules/backpack/Backpack/components/BackpackQuantityControl';
import { BackpackResourceCounter } from '../../../restored/modules/backpack/Backpack/components/BackpackResourceCounter';
...
export interface BackpackRestoredParams {
    ...
    readonly onAction?: (action: BackpackRestoredAction) => void;
}
...
export const BackpackRestored = defineView<BackpackRestoredParams | void>({ zIndex: 'window' }, (context) => {
    ...
    const emit = (id: string, action: BackpackRestoredAction['action'], value?: string | number) =>
    ...
    return (
        <view name="BackpackRestored" style={{ width: 750, height: 1334, backgroundColor: '#F3EFE9' }}>

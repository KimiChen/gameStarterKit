...
export const BattleLogSection = defineComponent<{ readonly row: BattleLogRow; readonly onToggle: () => void }>((p) => {
    ...
    return <view name="BattleLog/Section" style={{ position: 'relative', width: 660, height: height }}>
        ...
        <view name="BattleLog/SectionHeader" visible={!isRound} interaction="press" onClick={p.onToggle}
            accessibilityLabel={row.title} style={{ position: 'absolute', left: 4, width: 652, height: 52 }}>
        ...
        <view name="BattleLog/RoundHeader" visible={isRound} interaction="press" onClick={p.onToggle}
            accessibilityLabel={row.title} style={{ position: 'absolute', left: 4, width: 652, height: 54, backgroundColor: '#F6F1EA' }}>

...
export interface PreviewHomeParams {
    readonly onNavigate: (target: 'prompt' | 'small-popup' | 'backpack' | 'mail' | 'mail-restored' | 'backpack-restored' | 'settings' | 'character') => void;
}
...
export const PreviewHome = defineView<PreviewHomeParams, void>({ zIndex: 'screen' }, (context) => {
    ...
    return <view name="PreviewHome" style={{ width: 750, height: 1334, backgroundColor: '#101318', flexDirection: 'column', alignItems: 'center', padding: { top: 80 } }}>

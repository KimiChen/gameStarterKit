...
import {
    ...
    Mail, MailContent, MailShare, MailSoldierDetails, MailTroopDetails, MailBattleLog, MailReportDetail,
    MailBattleReport,
...
const PREVIEW_ALIASES: Record<string, string> = {
    ...
    mailshare: "mail-share",
    mailsoldierdetails: "mail-soldier-details",

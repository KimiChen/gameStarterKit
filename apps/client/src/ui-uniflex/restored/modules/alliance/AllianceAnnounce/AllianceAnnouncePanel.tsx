...
export const AllianceAnnouncePanel = defineComponent<AllianceAnnouncePanelProps>((p) => (
    <view name="AllianceAnnounce" visible={p.visible !== false}
        ...
        <view name="AllianceAnnounce/Mask" interaction="press"
            style={{ position: 'absolute', width: '100%', height: '100%', backgroundColor: '#00000099' }} />
        <view name="AllianceAnnounce/Window"
            style={{ position: 'absolute', left: 21, top: 318, width: 708, height: 912 }}>
            <PopupBackground kind="prompt" />
            <text value={p.title ?? '联盟公告'}

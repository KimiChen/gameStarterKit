/** AUTO-GENERATED by apps/server/tools/feature-codegen/cli.ts from features/<dir>/feature.json + apps/plugins/<id>/feature.json + <Name>View.view.json sidecars + apps/art/fairygui/assets. Do not edit. */

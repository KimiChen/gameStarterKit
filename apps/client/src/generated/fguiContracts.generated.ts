/** AUTO-GENERATED by apps/server/tools/plugin-codegen/cli.ts from apps/plugins/<id>/plugin.json + apps/plugins/<id>/plugin.json + <Name>View.view.json sidecars + apps/art/fairygui/assets. Do not edit. */

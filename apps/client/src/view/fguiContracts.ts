...
export const LOGIN_CONTRACT: FguiContract = {
  ...
  required: [{"name":"ld_logo","tsType":"GLoader"},{"name":"btn_copy","tsType":"GButton"},{"name":"btn_ageTip","tsType":"GButton"},{"name":"btn_musicon","tsType":"GButton"},{"name":"btn_musicoff","tsType":"GButton"},{"name":"btn_notice","tsType":"GButton"},{"name":"btn_account","tsType":"GButton"},{"name":"go_topBtns","tsType":"GGroup"},{"name":"go_top","tsType":"GGroup"},{"name":"txt_progress","tsType":"GTextField"},{"name":"go_bottom","tsType":"GGroup"},{"name":"go_container","tsType":"GComponent"},{"name":"txt_privacy","tsType":"GRichTextField"},{"name":"btn_select","tsType":"GButton"},{"name":"btn_login","tsType":"GButton"},{"name":"btn_server","tsType":"GButton"},{"name":"btn_test","tsType":"GButton"},{"name":"btn_clearDataCache","tsType":"GButton"}],
};

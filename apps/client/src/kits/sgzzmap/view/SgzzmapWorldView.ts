...
export class SgzzmapWorldView extends CocosView {
    ...
    protected onOpen(): void {
        ...
        //   anchor 不挂渲染件、只有 UITransform，屏幕上看不见，但 walk 会给出它的页面坐标中心 ——
        //   那就是地图区正中，点这里选到的必然是相机中心那一格。
        ...
        this.node("sgzz-map-anchor", this.root, width, this.mapTop - this.mapBottom)
            .setPosition(0, (this.mapBottom + this.mapTop) / 2);

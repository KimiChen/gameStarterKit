 ...
 * Creator builds use the real engine declarations. SC1-B1 predeclares the
 * planned SC1–SC4 3D surface from Creator 3.8.8, checked by stage3dTypes.test.ts.
 */
declare module "cc" {
  ...
  export class Node {
    ...
    addChild(child: Node): void; insertChild(child: Node, index: number): void;
    removeFromParent(): void; destroy(): boolean; setSiblingIndex(index: number): void;
    setPosition(position: Vec3): void; setPosition(x: number, y: number, z?: number): void; setScale(x: number, y: number, z?: number): void;

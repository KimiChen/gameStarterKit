...
import { AREALIST_CONTRACT, HOME_CONTRACT, LOGINNOTICE_CONTRACT, LOGIN_CONTRACT, STAGE3DSPIKEHUD_CONTRACT } from "./fguiContracts.generated";
...
export const GENERATED_VIEW_CATALOG: Readonly<Record<string, ViewMeta>> = {
    ...
    Stage3dFixture: defineView({
        name: "Stage3dFixture", kind: "cocos", layer: "base",
        fullscreen: true, onlyOne: true, permanent: false, interactive: false,
        load: () => import("../view/Stage3dFixtureView").then((m) => m.Stage3dFixtureView),
    }),
...
export const VIEW_SOURCE_RECORDS: readonly GeneratedViewSourceRecord[] = [
    ...
    { name: "Stage3dFixture", owner: "builtin", kind: "cocos", path: "apps/client/src/view/Stage3dFixtureView.ts", logic: "apps/client/src/logic/page/Stage3dFixtureLogic.ts", sidecar: "apps/client/src/view/Stage3dFixtureView.view.json" },
    { name: "Stage3dSpikeHud", owner: "builtin", kind: "fgui", pkg: "Common_Component", comp: "GoContainer", path: "apps/client/src/view/Stage3dSpikeHudView.ts", logic: "apps/client/src/logic/page/Stage3dFixtureLogic.ts", sidecar: "apps/client/src/view/Stage3dSpikeHudView.view.json" },

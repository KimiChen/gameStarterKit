...
import { createGameplayModule as createArenaCaptureGameplayModule } from "./modes/arenaCapture/index";
...
export const GAMEPLAY_MODULES = {
    "arenaCapture": createArenaCaptureGameplayModule,
...
export function registerGeneratedGameplays(
    ...
    try {
        disposers.push(registerGameplayModule(registry, createArenaCaptureGameplayModule(services), services.controllerBridge));

...
export function fetchMapTiles(rpc: Pick<LobbyRpcPort, "query">, mapId: string, rect: ISlgChunkRect): Promise<ISlgMapTilesRes> {
    return rpc.query(SlgRpc.MapTiles, { mapId, rect });
}

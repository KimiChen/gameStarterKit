...
export type SgzzLayerId =
    | "terrain" | "field" | "blend" | "grid" | "territory" | "border" | "decor"
...
export const SGZZ_LAYERS: readonly LayerGate[] = Object.freeze([
    ...
    // ⚠ **全档覆盖 LOD0–5**：⛔ 任何一档交给整幅底图，切档时岸线都会跳回旧轮廓。
    //   LOD5 要 32 块（缓存上限 48，放得下）。底图仍画在覆盖场之下，当填充期的兜底。
    { id: "field", hideAtLod: SGZZ_LOD_MAX, showFromLod: 0, streamed: true, implemented: true },

...
export const PopupBackground = defineComponent<{ readonly kind?: 'prompt' | 'small' | 'settings' }>((p) => (
    <view name="PopupBackground" style={{ position: 'absolute', width: '100%', height: '100%' }}>
        <image visible={p.kind !== 'small' && p.kind !== 'settings'} source={imageRef('ui/popup/prompt')}

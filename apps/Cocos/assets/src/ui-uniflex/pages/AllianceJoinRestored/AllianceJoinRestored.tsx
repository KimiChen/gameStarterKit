...
import { AllianceJoinRow } from '../AllianceJoin/AllianceJoinRow';
...
export interface AllianceJoinRestoredParams {
...
export const AllianceJoinRestored = defineView<AllianceJoinRestoredParams | void>({ zIndex: 'screen' }, (context) => {
    ...
    return (
        <view name="AllianceJoinRestored" style={{ width: 750, height: 1624 }}>
            ...
            <view name="AllianceJoinRestored/Search" interaction="press" onClick={search}
            ...
            <view name="AllianceJoinRestored/Create" interaction="press" onClick={openCreate}
            ...
            <view name="AllianceJoinRestored/Back" interaction="press" onClick={() => params.onBack?.()}

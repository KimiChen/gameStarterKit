...
export const componentSpecimens: readonly ComponentSpecimenSpec[] = [
    ...
    { id: "cmp-progress", group: "g-progress", groupLabel: "进度条", label: "英雄碎片", width: 320, height: 34, wide: false },
    { id: "cmp-progress-star", group: "g-progress", groupLabel: "进度条", label: "英雄升星", width: 391, height: 44, wide: false },
    { id: "cmp-progress-march", group: "g-progress", groupLabel: "进度条", label: "联盟行军", width: 420, height: 28, wide: false },
    { id: "cmp-progress-flag", group: "g-progress", groupLabel: "进度条", label: "联盟领地", width: 420, height: 28, wide: false },
    { id: "cmp-progress-battle-green", group: "g-progress", groupLabel: "进度条", label: "战斗绿条", width: 171, height: 29, wide: false },
    { id: "cmp-progress-battle-red", group: "g-progress", groupLabel: "进度条", label: "战斗红条", width: 171, height: 29, wide: false },
    { id: "cmp-marquee", group: "g-marquee", groupLabel: "跑马灯", label: "滚动公告", width: 674, height: 56, wide: true },
    { id: "cmp-countdown-days", group: "g-countdown", groupLabel: "倒计时", label: "x天 时:分:秒", width: 360, height: 56, wide: false },
    { id: "cmp-countdown-hours", group: "g-countdown", groupLabel: "倒计时", label: "时:分:秒", width: 360, height: 56, wide: false },
    { id: "cmp-countdown-minutes", group: "g-countdown", groupLabel: "倒计时", label: "分:秒", width: 360, height: 56, wide: false },
    { id: "cmp-countdown-chinese", group: "g-countdown", groupLabel: "倒计时", label: "中文单位", width: 360, height: 56, wide: false },

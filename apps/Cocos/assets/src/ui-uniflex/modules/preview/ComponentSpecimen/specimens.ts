...
export const componentSpecimens: readonly ComponentSpecimenSpec[] = [
    ...
    { id: "cmp-tabs", group: "cmp-items", groupLabel: "页签、数量与道具", label: "页签", width: 674, height: 82, wide: true },
    ...
    { id: "cmp-stars", group: "cmp-items", groupLabel: "页签、数量与道具", label: "星级", width: 240, height: 40, wide: false },

...
export const componentSpecimens: readonly ComponentSpecimenSpec[] = [
    ...
    { id: "cmp-countdown-days", group: "g-countdown", groupLabel: "倒计时", label: "x天 时:分:秒", width: 674, height: 56, wide: true },
    { id: "cmp-countdown-hours", group: "g-countdown", groupLabel: "倒计时", label: "时:分:秒", width: 674, height: 56, wide: true },
    { id: "cmp-countdown-minutes", group: "g-countdown", groupLabel: "倒计时", label: "分:秒", width: 674, height: 56, wide: true },
    { id: "cmp-countdown-chinese", group: "g-countdown", groupLabel: "倒计时", label: "中文单位", width: 674, height: 56, wide: true },

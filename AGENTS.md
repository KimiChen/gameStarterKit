...
> - [docs/3D-PLAN.md](docs/3D-PLAN.md)：3D 实施施工单（2026-09-19 初稿、2026-09-24 v1.6；含 3D-13–3D-45 五轮审阅记录与 L01–L09，五项新增问题按批次实施；SC0 / SC1 / SC2 / SC3 已退出，SC4-B1 / B2 / B3 已完成、SC4 进行中，SC5 未开始；SC0–SC5 拆成 `SCx-Bn` 批次：文件落点、机检退出、命令；消费方 lvr A0–A5 / mmo（SD9）/ slg 接法；批次勾选只在其 §8，阶段级完成仍回写 3d.md §10；⛔ 不是设计真源、不进 plan-v5）
